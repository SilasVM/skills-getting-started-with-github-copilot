...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 16,
        "participants": ["mia@mergington.edu", "nora@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stage production, and performance skills",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["jason@mergington.edu", "bella@mergington.edu"]
    },
    "Math Club": {
        "description": "Work on math challenges, competitions, and problem solving",
        "schedule": "Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 15,
        "participants": ["sam@mergington.edu", "emma@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science competitions with lab experiments and study",
